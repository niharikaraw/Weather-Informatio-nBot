...
def reply_weather_info(data, uuid, city=None):
    ...
    I1.text(xy=(10, 180), text="{}".format(place), font=ImageFont.truetype("C:\Users\91955\OneDrive\Desktop\Weather Bot\weatherbot\.fonts\Microsoft Himalaya.ttf", 40), fill ='navy')
